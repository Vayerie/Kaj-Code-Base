	...
	run: async (client, interaction) => {
		try {
			...
			const ticketButtons = new ActionRowBuilder().setComponents([
				new ButtonBuilder().setCustomId('closeTicketBtn').setLabel('Close Ticket').setStyle(ButtonStyle.Danger),
				new ButtonBuilder().setCustomId('lockTicketBtn').setLabel('Lock Ticket').setStyle(ButtonStyle.Success),
			]);
